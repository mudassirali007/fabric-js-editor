...
(function () {
   ...
   * 
   */
  var ImageEditor = function (containerSelector, buttons,icons, shapes) {
    ...
    this.setActiveAnimation = () => {
      ...
      try {
        ...
        duration.value = animation?.delay ?? 2.5;
    ...
    this.setActiveTool = (id) => {
      ...
      $(`${containerSelector} .toolpanel`).removeClass("closed");
      ...
      if (id !== "select" && this.activeSelection?.id !== 'ogImage') {
