...
(function () {
  ...
  var canvas = function () {
    try {
      $(`${this.containerSelector} .main-panel`).append(`<div class="canvas-holder" id="canvas-holder"><div class="content"><div id="guidelayer" class=""></div><canvas id="c"></canvas></div></div>`);
