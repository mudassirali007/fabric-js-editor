...
(function () {
  ...
  var defaultButtons = [
    ...
    },
    {
      name: "icons",
      title: "Icons",
      icon: `<svg viewBox="0 0 752 752" version="1.1" xmlns="http://www.w3.org/2000/svg"><g></g><g><path fill="#000000" opacity="1.00" d=" M 370.54 91.14 C 377.71 88.66 385.89 92.98 389.08 99.62 C 484.62 265.06 580.37 430.37 676.05 595.73 C 678.49 599.53 680.35 603.95 679.79 608.56 C 679.44 617.03 671.42 624.17 662.97 623.63 C 470.96 623.68 278.95 623.65 86.94 623.65 C 80.51 624.10 73.96 620.59 71.00 614.83 C 68.83 611.38 69.37 607.06 69.78 603.21 C 71.25 598.95 73.98 595.29 76.12 591.36 C 170.10 428.54 264.15 265.76 358.16 102.96 C 360.84 97.82 364.65 92.70 370.54 91.14 Z"></path></g></svg>`
    },
    {
      name: "shapes",
      title: "Shapes",
