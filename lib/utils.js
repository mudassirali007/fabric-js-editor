...
fabric.Image.prototype.resizeFilters = {
  'Saturation': false,
  'Brightness': false,
  'Blur': false,
  'Gamma': false,
...
const getShadow = ({ blur = 5, offsetX = 8, offsetY = 10, color = 'rgba(0, 0, 0, 0.65)' }) => {
...
const downloadImage = (data, extension = 'png', mimeType = 'image/png') => {
  ...
  const fileName = (writtenText.value && writtenText.value.trim()) || 'image';
